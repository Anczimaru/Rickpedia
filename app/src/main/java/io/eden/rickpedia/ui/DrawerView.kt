        ...
        TopAppBar(
            ...
            actions = {
                when {
                    ...
                    title in listOf(
                        Screen.CharacterListScreen.title,
                        Screen.EpisodesListScreen.title,
                        Screen.LocationListScreen.title
                    ) -> {
...
fun DrawerMenu(
    ...
    LazyColumn() {
        items(drawerScreens) { item ->
            DrawerItem(
                selected = (currentTitle.equals("Rickpedia") && item.dTittle.equals(Screen.DrawerScreen.Home.title)) || item.dTittle == currentTitle,
